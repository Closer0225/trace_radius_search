...
rem echo %CUDA_PATH%
rem set CUDA_PATH=C:/Program Files/NVIDIA GPU Computing Toolkit/CUDA/v12.2/
set OPTIX_PATH=%OPTIX_PATH%/
rem set OPTIX_PATH=C:/ProgramData/NVIDIA Corporation/OptiX SDK 7.6.0/
rem echo %OPTIX_PATH%
set CCBIN="C:/Program Files (x86)/Microsoft Visual Studio/2019/Community/VC/Tools/MSVC/14.29.30133/bin/Hostx64/x64"
set OUTPUT_PTX_PATH=./data/
set OUTPUT_PTX_EXT=.ptx
set sm_arch=60
dir /b /s "src\*.cu"  > compile_cuda_list_tmp.txt
