...
namespace bvh_radSearch
{
    ...
    public:
        ...
        template<typename V>
        __host__ __device__ __forceinline__ inline V* getPtr(void) noexcept { return reinterpret_cast<V*>(this->mHandle); }

        __host__ __device__ __forceinline__ inline T* getPtr(void) noexcept { return reinterpret_cast<T*>(this->mHandle); }
